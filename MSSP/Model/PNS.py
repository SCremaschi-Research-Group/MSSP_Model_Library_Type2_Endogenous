...
def MSSP_model(I, IU, K, K126, STEP, T, T_end, S,
	...
	def E3_B3(model,l,t,s): 
		return model.Wrate_kts[3,t,s] <= model.theta_ils[1,l,s]*model.Wrate_kts[1,t,s] + Big_M*(1-model.B_ilts[1,l,t,s]) # Stream 9 is a vent for complete recourse
	model.E3_B3 = Constraint(STEP,T,S, rule = E3_B3)
	# model.E3_B3.pprint()

	def E4_B4(model,l,t,s): 
		return model.Wrate_kts[3,t,s] >= model.theta_ils[1,l,s]*model.Wrate_kts[1,t,s] - Big_M*(1-model.B_ilts[1,l,t,s]) # Stream 9 is a vent for complete recourse
	model.E4_B4 = Constraint(STEP,T,S, rule = E4_B4)
	# model.E4_B4.pprint()

	def E5_B5(model,l,t,s): 
		return model.Wrate_kts[4,t,s] <= model.theta_ils[2,l,s]*model.Wrate_kts[2,t,s] + Big_M*(1-model.B_ilts[2,l,t,s]) # Stream 10 is a vent for complete recourse
	model.E5_B5 = Constraint(STEP,T,S, rule = E5_B5)
	# model.E5_B5.pprint()

	def E6_B6(model,l,t,s): 
		return model.Wrate_kts[4,t,s] >= model.theta_ils[2,l,s]*model.Wrate_kts[2,t,s] - Big_M*(1-model.B_ilts[2,l,t,s]) # Stream 10 is a vent for complete recourse
	model.E6_B6 = Constraint(STEP,T,S, rule = E6_B6)
	# model.E6_B6.pprint()
