...
def MSSP_model(Omega_S, Omega_E, Omega_Estar, Omega_L, Omega_N, Omega_O, Omega_T, Omega_G, Omega_DG, Omega_K, Omega_KT_k,
	...
	# Othre variables for complete recourse
	...
	def I22DSR(model,s): # DSR operational cost
		return model.zaiODSR_s[s] == sum(ro_e[e]*w_t[t]*model.Xi_nets[n,e,t,s]*cDSR + model.dR_nets[n,e,t,s]*cDR for e in Omega_E for t in Omega_T for n in Omega_N)
	model.I22DSR = Constraint(Omega_S, rule = I22DSR)
	# model.I22DSR.pprint()
	
	def I22DG(model,s): # DG operational cost
	...
	model.I22DG = Constraint(Omega_S, rule = I22DG)
	# model.I22DG.pprint()
	...
	def I23(model,n,e,t,s): # Energy balance at every bus n
		return sum(model.PG_gets[g,e,t,s]*I_ng[n,g] for g in Omega_G) + sum(model.PL_lets[l,e,t,s]*L_nl[n,l] for l in Omega_L) == model.T_nets[n,e,t,s] - model.Xi_nets[n,e,t,s] + d_net[n,e,t] - model.dR_nets[n,e,t,s]
	model.I23 = Constraint(Omega_N, Omega_E, Omega_T, Omega_S, rule = I23)
	# model.I23.pprint()
